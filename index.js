    ...
    askMedia($) {
      ...
      $.waitForRequest
          .then($ => {
            ...
            } else if ($.message.text == 'wired'){
              client.get("https://newsapi.org/v1/articles?source=wired-de&sortBy=latest&apiKey=c95262ea5eed4b61b6cb31ac2f1567af", function (data) {
                'use strict';
                var url_1 = data.articles[0].url,
                    url_2 = data.articles[1].url,
                    url_3 = data.articles[2].url,
